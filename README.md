...
This Rust Roguelike is a Roguelike written in Zig (originally written in Rust).
It is a Roguelike with a focus on movement, use of space, stealth, and some
resource management.  It has themes of deserts, ancient ruins, mechanisms, and
the sun.
...
![Image](data/sprites/misc/background.png)
![Screenshot](data/doc/screenshot.png)
...
The 'm' key opens a window with a longer message log of events in the game then the log
shown when playing. THis can be used to look back at longer lists of events or previous turns.
...
The game generates performance information which can be viewed using remotery.
