...
// This global interpreter is provided as a convenience for single interpreter programs
// where global access to the interpreter makes running TCL code within Zig easier.
pub var interp: obj.Interp = undefined;
